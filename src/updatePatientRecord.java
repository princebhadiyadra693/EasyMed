...
public class updatePatientRecord extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         ...
         String patietnid=jTextField1.getText().trim();
      
        try{
            Connection con=ConnectionProvider.getcon();
            Statement st=con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
            ResultSet rs=st.executeQuery("select * from patient where pat_id='"+patietnid+"'");
            ...
            {
                JOptionPane.showMessageDialog(null, "Patient Id Does not Found");
            }
        }
        catch(Exception e)
        {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            st.executeUpdate("update patient set pat_fname='"+fname+"',pat_mname='"+mname+"',pat_lname='"+lname+"',pat_gender='"+gender+"',pat_city='"+city+"',pat_state='"+state+"',pat_number='"+mobileno+"'");
